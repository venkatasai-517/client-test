...
function App() {
  ...
  const fetchRooms = async () => {
    try {
      const response = await axios.get(
        "https://hostel-maintanance-mongodb-3.onrender.com/hostel/threeshares"
      );
    ...
    try {
      ...
      if (selectedRecord) {
        ...
        response = await axios.put(
          `https://hostel-maintanance-mongodb-3.onrender.com/hostel/threeshare/${selectedRecord.id}`,
          formData,
          {
            headers: {
        ...
        response = await axios.post(
          "https://hostel-maintanance-mongodb-3.onrender.com/hostel/threeshare",
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
  ...
  const submitEditHandler = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `https://hostel-maintanance-mongodb-3.onrender.com/hostel/threeshares/${id}`,
        data,
        {
          headers: {
            "Content-Type": "multipart/form-data",
